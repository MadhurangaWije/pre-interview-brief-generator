...
import { EventProcessDto } from "./EventProcessDto";
...
export class TranscodeConsumer {
  ...
  @Process()
    async transcode(job: Job<EventProcessDto>) {
    this.logger.log(JSON.stringify(job))
    const dto: InterviewBriefRequestDto = job.data.data;
...
<noscript>
  <img height="1" width="1" style="display:none;" alt src="https://px.ads.linkedin.com/collect/?pid=3252572&amp;fmt=gif">
    ...
    this.logger.log('preInterviewBrief', preInterviewBrief);
